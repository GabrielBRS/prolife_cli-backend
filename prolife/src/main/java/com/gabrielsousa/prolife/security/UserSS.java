package com.gabrielsousa.prolife.security;
...
public class UserSS implements UserDetails{
	...
	public UserSS(Integer id, String email, String password, Set<UsersTypes> perfis) {
		super();
		this.id = id;
		this.email = email;
	...
	public boolean hasRole(UsersTypes perfil) {
